...
@property (nonatomic, copy) NSString * _Nonnull moduleType;
...
- (BOOL)readSettingWithSettingIndex:(uint8_t)settingIndex callback:(BOOL (^ _Null_unspecified)(BOOL))callback SWIFT_WARN_UNUSED_RESULT;
...
- (BOOL)doAction_ATC_StorageOn SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_ATC_StorageOff SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_ATC_OutOfServiceOn SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_ATC_OutOfServiceOff SWIFT_WARN_UNUSED_RESULT;
- (void)clearLog;
...
- (BOOL)doAction_ReadKeyfobWithKeyfob_index:(NSInteger)keyfob_index SWIFT_WARN_UNUSED_RESULT;
- (void)doAction_WriteKeyfobWithKeyfob:(uint64_t)keyfob uuid0:(uint64_t)uuid0 uuid1:(uint64_t)uuid1 major:(NSInteger)major minor:(NSInteger)minor keyfob_index:(NSInteger)keyfob_index encryptionEnable:(BOOL)encryptionEnable;
...
- (BOOL)doAction_ForceUnlock SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_LockTether SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_Test2 SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_Test3 SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_Test4 SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_Test5 SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_Test6 SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_Test7 SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_Test8 SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_Test9 SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_Test10 SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_Test11 SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_Sleep SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_ResetReboot SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_HardReset SWIFT_WARN_UNUSED_RESULT;
...
- (BOOL)doAction_SetResetTimerWithSetting:(NSString * _Nonnull)setting SWIFT_WARN_UNUSED_RESULT;
...
- (BOOL)doAction_SetCanNodeIdWithSetting:(NSString * _Nonnull)setting SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_SetCanConfigWithSetting:(NSString * _Nonnull)setting SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_SetCanSupportWithSetting:(NSString * _Nonnull)setting SWIFT_WARN_UNUSED_RESULT;
...
- (BOOL)doAction_SetLedModeWithSetting:(NSString * _Nonnull)setting SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_SetCanProtocolWithSetting:(NSString * _Nonnull)setting SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_SetAdvPwrWithSetting:(NSString * _Nonnull)setting SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_SetchargePercentStartWithSetting:(NSString * _Nonnull)setting SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_SetchargePercentStopWithSetting:(NSString * _Nonnull)setting SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_SetchargeTempStopWithSetting:(NSString * _Nonnull)setting SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_SetchargeTempStartWithSetting:(NSString * _Nonnull)setting SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_SetMotionInactivityWithSetting:(NSString * _Nonnull)setting SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_SetLockRetryWithSetting:(NSString * _Nonnull)setting SWIFT_WARN_UNUSED_RESULT;
- (BOOL)doAction_SetMotorAssistWithSetting:(NSString * _Nonnull)setting SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic) BOOL AllowLockingInBackground;
@property (nonatomic) BOOL OnlyUnlockUsingBluetooth;
...
- (void)doRead_setting_keyfobWithKeyfob_index:(NSInteger)keyfob_index;
...
- (void)assignKeyfobWithKeyfob_qr:(NSString * _Nonnull)keyfob_qr keyfob_index:(NSInteger)keyfob_index delegate:(id <KeyfobAssignDelegate> _Nonnull)delegate;
- (BOOL)unassignKeyfob SWIFT_WARN_UNUSED_RESULT;
- (BOOL)unassignKeyfobWithKeyfob_index:(NSInteger)keyfob_index SWIFT_WARN_UNUSED_RESULT;
- (void)tryAgainUnlock;
- (void)doSleep;
- (void)doSiren;
- (void)tryAgainLock;
...
/// Check if lock has been detected
/// \param macAddress MAC address of the lock
///
///
/// returns:
/// Bool, true if lock has been detected, false otherwise
...
- (void)onReadSettingKeyfobWithKeyfobId:(NSString * _Nonnull)keyfobId keyfob_index:(NSInteger)keyfob_index;
...
SWIFT_CLASS("_TtC11LinkaAPIKit15LockValuePacket")
@interface LockValuePacket : LockDataPacket
@end


SWIFT_CLASS("_TtC11LinkaAPIKit18LockValuePacketRaw")
@interface LockValuePacketRaw : LockDataPacket
@end
...
SWIFT_CLASS("_TtC11LinkaAPIKit9TestFlags")
@interface TestFlags : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
